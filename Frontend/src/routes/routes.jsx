...
import { ActivitiesFeed, ActivityDetailPage, ChangePassword, CheckCode, Contact, CrearActivity, Dashboard, Home, Login, Main, Profile, Register, UpdateUser } from '../pages'
import App from '../App'
